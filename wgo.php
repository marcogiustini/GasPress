...
add_action('wp_enqueue_scripts', function () use ($plugin_version) {
    wp_enqueue_style('wgo-style', plugin_dir_url(__FILE__) . 'assets/css/wgo-style.css', [], $plugin_version);
    wp_enqueue_script('wgo-script', plugin_dir_url(__FILE__) . 'assets/js/wgo-script.js', [], $plugin_version, true);
});
