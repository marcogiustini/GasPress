...
function wgo_render_global_pickup_settings() {
    ...
    echo '<p><input type="submit" name="wgo_save_global_pickup" class="button button-primary" value="Salva"></p>';
    echo '</form></div>';

    if (isset($_POST['wgo_save_global_pickup'])) {
        wgo_set_global_pickup_point($_POST['wgo_global_pickup']);
        echo '<div class="updated"><p>Punto di ritiro aggiornato.</p></div>';
    }
}
